...
from astock_fundamentals.core.cas_vocabulary import BALANCE_SHEET_ITEMS, INCOME_STATEMENT_ITEMS, CASH_FLOW_ITEMS
...
class SemanticRecovery:
    ...
    def recover_from_html(self, pdf_path: str, page_nums: List[int],
        ...
        from astock_fundamentals.sources.pdf.parsers.html_converter import convert_pdf_to_html
        import os
        import shutil
        import tempfile
