...
from astock_fundamentals.sources.pdf.parsers.lo_table_parser import LibreOfficeTableParser
from astock_fundamentals.sources.pdf.parsers.html_converter import convert_pdf_to_html, is_garbled_text
...
try:
    from astock_fundamentals.sources.pdf.parsers.ocr_parser import OCRTableParser
    HAS_OCR = True
except ImportError:
    HAS_OCR = False
    OCRTableParser = None
...
class HybridParser:
    ...
    def _check_and_convert_if_needed(self):
        ...
        # 使用全页CID扫描检测乱码页面
        from astock_fundamentals.core.cid_detector import CIDFontDetector
