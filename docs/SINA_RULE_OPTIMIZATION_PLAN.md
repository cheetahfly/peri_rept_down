...
### 阶段 1 进度
- 开始时间: 2026-06-04
- 1.1 baseline 支持 2000-2022: ✅ **完成** (脚本已接受 --years 范围)
- 1.2 跑 baseline: ✅ **完成** (7 年抽样 2000/2005/2010/2015/2018/2020 + 2022 阻塞超时)
- 1.3 按年份分析: ✅ **完成** (见 baseline_per_year.json)
- 1.4 提取 2000-2010 别名: _未开始_
- 1.5 重跑验证: _未开始_
- 1.6 提交 + 报告: _未开始_
- **阶段 1 完成时间**: _TBD_
- **阶段 1 末匹配率 (按年加权)**: 
  - BS: 99.05% (2000-2020 累计)
  - IS: 99.85%
  - CF: 99.17% (从 87% 提升 **+12 个百分点**)
- **关键发现**: 早期年份 (2000-2005) BS/CF 各有 2-4% 未匹配项，需阶段 1.4 处理
