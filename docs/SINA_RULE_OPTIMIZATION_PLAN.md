...
- 全量验证: 3903 stocks × 47,966 comparisons
- 测试: 30+ tests

### 匹配率 (3903 stocks × 7 years, 2000-2022) — 全量验证
| 报表 | 基线 (Session 初) | 最终 | 提升 | 目标 |
|------|-------------------|------|------|------|
| BS | 99.59% | **99.73%** | +0.14% | ≥99.85% ❌差0.12% |
| IS | 99.30% | **99.79%** | +0.49% | ≥99.50% ✅ |
| CF | 88.93% | **96.87%** | **+7.94%** | ≥92% ✅ |
