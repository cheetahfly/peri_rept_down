...
REGRESSION_TEST_STOCKS = [
    ...
    },
    {
        ...
        "expected_items": {
            ...
            "净利润": {"min": 4000000000, "max": 5000000000},
        },
        "min_confidence": 0.95,
    },
    {
        "stock_code": "600089",
        "pdf_file": "600089_特变电工_2024_年报.pdf",
        "year": 2024,
        "expected_items": {
            "资产总计": {"min": 1500000000000, "max": 2000000000000},
            "净利润": {"min": 5000000000, "max": 10000000000},
        },
        "min_confidence": 0.80,
        "note": "特变电工 - 电气设备龙头",
    },
    {
        "stock_code": "600196",
        "pdf_file": "600196_复星医药_2024_年报.pdf",
        "year": 2024,
        "expected_items": {
            "资产总计": {"min": 800000000000, "max": 1200000000000},
            "净利润": {"min": 2000000000, "max": 5000000000},
        },
        "min_confidence": 0.80,
        "note": "复星医药 - 医药龙头",
    },
    {
        "stock_code": "603501",
        "pdf_file": "603501_韦尔股份_2024_年报.pdf",
        "year": 2024,
        "expected_items": {
            "资产总计": {"min": 300000000000, "max": 500000000000},
            "净利润": {"min": 2000000000, "max": 5000000000},
        },
        "min_confidence": 0.80,
        "note": "韦尔股份 - 半导体设计龙头",
...
EXTENDED_REGRESSION_STOCKS = [
    {
        "stock_code": "600036",
        "pdf_file": "600036_招商银行_2024_年报.pdf",
        "year": 2024,
        "expected_items": {
            "资产总计": {"min": 10000000000000, "max": 12000000000000},
            "净利润": {"min": 10000000000, "max": 15000000000},
        },
        "min_confidence": 0.80,
        "note": "LibreOffice模式",
    },
    {
        "stock_code": "600111",
        "pdf_file": "600111_北方稀土_2024_年报.pdf",
        "year": 2024,
        "expected_items": {
            "资产总计": {"min": 30000000000, "max": 50000000000},
            "净利润": {"min": 1500000000, "max": 3000000000},
        },
        "min_confidence": 0.80,
        "note": "LibreOffice模式",
    },
    {
        "stock_code": "600900",
        "pdf_file": "600900_长江电力_2024_年报.pdf",
        "year": 2024,
        "expected_items": {
            "资产总计": {"min": 7000000000000, "max": 10000000000000},
            "净利润": {"min": 7000000000, "max": 10000000000},
        },
        "min_confidence": 0.80,
        "note": "电力行业龙头",
    },
    {
        "stock_code": "600048",
        "pdf_file": "600048_保利发展_2024_年报.pdf",
        "year": 2024,
        "expected_items": {
            "资产总计": {"min": 7000000000000, "max": 10000000000000},
            "净利润": {"min": 1000000000, "max": 3000000000},
        },
        "min_confidence": 0.75,
        "note": "房地产龙头",
    },
